...
public class SingleClassArgument {
	...
	public void one(boolean a,int b) {     // Non static method overloading ---same one()
		System.out.println ("one() Non static method in SingleClassArgument class");
	}
	public void one(int a) {  // Non static method overloading ---same one()
		System.out.println("one(int a)Non static method in SingleClassArgument class");
	} 
	public static void two() {  //static method overloading ---same one()
		System.out.println("two() static method in SingleClassArgument");
	}
	public static void two(String s) {  //static method overloading ---same one()
